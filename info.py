...
PICS = (environ.get('PICS', 'https://graph.org/file/e9e6ae173ef5e880a4587.jpg')).split()#SAMPLE PIC
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+8rJyExo0kiAzNmE1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+sKygp7iBsoIyNzk1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/MAPOriginal')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -1002126954277'))
...
URL = "https://zishan-o8bc.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://zishan-o8bc.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://zishan-o8bc.onrender.com/".format(FQDN)
else:
    URL = "https://zishan-o8bc.onrender.com/".format(FQDN)
